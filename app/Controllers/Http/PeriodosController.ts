...
export default class PeriodosController {
  public async showAll() {
    ...
    .query()
    .from('periodo')
    .select('per_id','per_nombre','per_anio','per_semestre','per_fecha_inicio','per_fecha_fin')
    .orderBy('per_id')
  }
  ...
  public async update(per_nombre_old:string,data:any) {
    try{
      const periodo = await Periodo.findByOrFail("per_nombre",per_nombre_old);
